    ...
    <section className="pt-32 pb-20 md:pt-40 md:pb-32 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div 
          ...
          className="absolute w-[800px] h-[800px] rounded-full bg-primary/5 -top-[400px] -right-[400px] transition-transform duration-1000 ease-out"
        />
      ...
      <div className="container mx-auto px-4 relative z-20">
        ...
        <div className="mt-16 relative max-w-5xl mx-auto animate-scale-in" style={{ animationDelay: '0.4s' }}>
          ...
          <div className="absolute -bottom-8 -left-8 w-24 h-24 rounded-full bg-accent/10 animate-float" style={{ animationDelay: '1s' }}></div>
        </div>
      </div>
    </section>
  );
